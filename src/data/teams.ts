 ...
 */
export function findTeamsByName(pattern: string): Team[] {
  const regex = new RegExp(pattern, 'i')
  return teams.filter(
    (team) =>
      regex.test(team.fullName) ||
 ...
 */
export function findTeamById(teamId: number): Team | null {
 ...
 */
export function findTeamByAbbreviation(abbreviation: string): Team | null {
 ...
 */
export function findTeamsByState(state: string): Team[] {
 ...
 */
export function findTeamsByCity(city: string): Team[] {
 ...
 * Get all team IDs.
 */
export function getTeamIds(): number[] {
