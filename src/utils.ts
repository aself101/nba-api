 ...
 */
function extractV3PlayerIdentity(player: Record<string, unknown>): Record<string, unknown> {
  return {
 ...
 */
function extractV3TraditionalStats(stats: Record<string, unknown>): Record<string, unknown> {
  return {
 ...
 */
function extractV3AdvancedStats(
