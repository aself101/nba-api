  ...
  try {
    ...
    if (opts.liveScoreboard) {
      ...
      try {
        ...
        reporter.logError('liveScoreboard', (error as Error).message)
      }
    }
    ...
    if (opts.liveOdds) {
      ...
      try {
        ...
        reporter.logError('liveOdds', (error as Error).message)
      }
    }
    ...
    if (opts.playByPlay && opts.gameId) {
      ...
      try {
        ...
        reporter.logError('playByPlay', (error as Error).message)
      }
    }
    ...
    if (opts.scoreboard) {
      ...
      try {
        ...
        reporter.logError('scoreboard', (error as Error).message)
      }
    }
    ...
    if (opts.playerCareer && opts.playerId) {
      ...
      try {
        ...
        reporter.logError('playerCareerStats', (error as Error).message)
      }
    }
    ...
    if (opts.playerInfo && opts.playerId) {
      ...
      try {
        ...
        reporter.logError('commonPlayerInfo', (error as Error).message)
      }
    }
    ...
    if (opts.teamHistory && opts.teamId) {
      ...
      try {
        ...
        reporter.logError('teamYearByYearStats', (error as Error).message)
      }
    }
