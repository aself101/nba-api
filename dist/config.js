 ...
 */
export function parseSeasonYear(season) {
...
export function validateSeason(season) {
    ...
    if (endYearSuffix !== expectedEndSuffix) {
        throw new Error(`Invalid season: ${season}. End year suffix should be ${String(expectedEndSuffix).padStart(2, '0')}`);
    }
 ...
 */
export function generateSeasonRange(startYear, endYear) {
...
export function validateGameId(gameId) {
    ...
    if (!pattern.test(gameId)) {
        throw new Error(`Invalid game ID: ${gameId}. Must be a 10-digit string (e.g., "0022400001").`);
    }
}
/**
...
export function validateEnum(value, allowedValues, paramName) {
    if (!allowedValues.includes(value)) {
        throw new Error(`Invalid ${paramName}: "${value}". Allowed values: ${allowedValues.join(', ')}`);
    }
}
// =============================================================================
// Date Utilities
 ...
 */
export function getSeasonStartDate(seasonYear) {
 ...
 * @param seasonYear - The starting year of the season
 */
export function getSeasonEndDate(seasonYear) {
